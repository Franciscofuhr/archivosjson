...
def agregar_fila_csv(legajo, nombre, apellido, nota1, nota2):
    ...
    try:
        with open('datosAlumnos.csv', mode='x', newline='') as archivo_csv:
    ...
    with open('datosAlumnos.csv', mode='r', newline='') as archivo_csv:
    ...
    with open('datosAlumnos.csv', mode='a', newline='') as archivo_csv:
        writer = csv.writer(archivo_csv, delimiter=';')
        writer.writerow([legajo, nombre, apellido, nota1, nota2])
