...
def buscar_alumno(lista_diccionarios, frame_principal):
    ...
    def mostrar_resultado_alumno(alumno):
        ...
        boton_volver = ctk.CTkButton(frame_principal, text="Volver al menú de búsqueda", command=mostrar_menu_busqueda)
    ...
    def mostrar_menu_busqueda():
        ...
        boton_buscar_id = ctk.CTkButton(frame_principal, text="Buscar por ID", fg_color="#061b2c", width=200, command=lambda: buscar_por_criterio('ID'))
